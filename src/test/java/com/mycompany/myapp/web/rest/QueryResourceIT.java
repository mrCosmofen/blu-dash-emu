...
public class QueryResourceIT {
    ...
    public void createQuery() throws Exception {
        ...
        // Create the Query
        restQueryMockMvc.perform(post("/api/queries").with(csrf())
    ...
    public void updateQuery() throws Exception {
        ...
        restQueryMockMvc.perform(put("/api/queries").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteQuery() throws Exception {
        ...
        // Delete the query
        restQueryMockMvc.perform(delete("/api/queries/{id}", query.getId()).with(csrf())
