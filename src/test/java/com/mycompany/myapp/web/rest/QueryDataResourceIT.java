...
public class QueryDataResourceIT {
    ...
    public void createQueryData() throws Exception {
        ...
        restQueryDataMockMvc.perform(post("/api/query-data").with(csrf())
    ...
    public void updateQueryData() throws Exception {
        ...
        restQueryDataMockMvc.perform(put("/api/query-data").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteQueryData() throws Exception {
        ...
        restQueryDataMockMvc.perform(delete("/api/query-data/{id}", queryData.getId()).with(csrf())
