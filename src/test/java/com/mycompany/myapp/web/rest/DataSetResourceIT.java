...
import com.mycompany.myapp.repository.DataSetRepository;
...
public class DataSetResourceIT {
    ...
    public void createDataSet() throws Exception {
        ...
        // Create the DataSet
        restDataSetMockMvc.perform(post("/api/data-sets").with(csrf())
    ...
    public void updateDataSet() throws Exception {
        ...
        restDataSetMockMvc.perform(put("/api/data-sets").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteDataSet() throws Exception {
        ...
        // Delete the dataSet
        restDataSetMockMvc.perform(delete("/api/data-sets/{id}", dataSet.getId()).with(csrf())
