...
public class BluFieldValueResourceIT {
    ...
    public void createBluFieldValue() throws Exception {
        ...
        restBluFieldValueMockMvc.perform(post("/api/blu-field-values")
    ...
    public void updateBluFieldValue() throws Exception {
        ...
        restBluFieldValueMockMvc.perform(put("/api/blu-field-values")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBluFieldValue() throws Exception {
        ...
        restBluFieldValueMockMvc.perform(delete("/api/blu-field-values/{id}", bluFieldValue.getId())
