...
import com.mycompany.myapp.domain.enumeration.BluFieldType;
/**
...
public class BluFieldResourceIT {
    ...
    public void createBluField() throws Exception {
        ...
        // Create the BluField
        restBluFieldMockMvc.perform(post("/api/blu-fields").with(csrf())
    ...
    public void updateBluField() throws Exception {
        ...
        restBluFieldMockMvc.perform(put("/api/blu-fields").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBluField() throws Exception {
        ...
        // Delete the bluField
        restBluFieldMockMvc.perform(delete("/api/blu-fields/{id}", bluField.getId()).with(csrf())
