...
public class BluFormResourceIT {
    ...
    public void createBluForm() throws Exception {
        ...
        // Create the BluForm
        restBluFormMockMvc.perform(post("/api/blu-forms").with(csrf())
    ...
    public void updateBluForm() throws Exception {
        ...
        restBluFormMockMvc.perform(put("/api/blu-forms").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBluForm() throws Exception {
        ...
        // Delete the bluForm
        restBluFormMockMvc.perform(delete("/api/blu-forms/{id}", bluForm.getId()).with(csrf())
