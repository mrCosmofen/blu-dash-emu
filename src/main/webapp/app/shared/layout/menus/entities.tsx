...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/blu-form-data">
      <Translate contentKey="global.menu.entities.bluFormData" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/blu-field-string-value">
      <Translate contentKey="global.menu.entities.bluFieldStringValue" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/blu-field-number-value">
      <Translate contentKey="global.menu.entities.bluFieldNumberValue" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/blu-field-currency-value">
      <Translate contentKey="global.menu.entities.bluFieldCurrencyValue" />
    </MenuItem>
